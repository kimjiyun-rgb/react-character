...
const animeCharacters = [
  ...
  },
  {
    ...
    imageUrl: 'http://127.0.0:5500/todorokishoto',
  },
  {
    id: 106,
    name: 'Ai Hoshino',
    description: '호시노 아이는 최애의 아이의 등장인물로 본작의 키 퍼슨이기도 합니다. 두 주인공인 아쿠아마린과 루비의 친엄마이며 이치고 프로덕션의 아이돌 그룹 B코마치의 부동의 센터이고 전설의 아이돌이라 칭해질 정도로 인기를 끌었습니다. 여러 모로 눈에 띄게 아이돌의 재능을 보였던 인물로 무대에 나타나서든 스크린에 나타나서든 사람의 시선을 본능적으로 끌어들이는 매력을 지녔습니다.',
    imageUrl: 'http://127.0.0:5500/hoshinoai',
  },
